...
util.inherits(Nen1878FileReader, events.EventEmitter);


function Nen1878FileReader(parser, filename, bufferSize) {
    this.parser = parser;
...
Nen1878FileReader.prototype.start = function() {
...
module.exports = Nen1878FileReader;
