...
var parser04 = {
    ...
    'Y': function(subLine) {
        ...
        coordinate = {
            ...
            functie: coordinate.functie
        };
    },
    'Q': function(subLine) {
        this.geometry.precisieKlasse = parseInt(subLine.slice(3, 4), 10); // precisieklasse: 0 = onbekend (LKI-klasse 9), 1 = 1 cm, 2 = 5 cm, 3 = 12 cm, 4 = 23 cm, 5 = 46 cm, 6 = 100 cm, 7 = 250 cm
        this.geometry.idealisatieKlasse = parseInt(subLine.slice(6, 7), 10); // idealisatieklasse: 0 = onbekend (LKI-klasse 9), 1 = 0 - 2cm, 2 = 2 - 5cm, 3 = 5 - 10 cm, 4 = > 10cm
        this.geometry.betrouwbaarheid = parseInt(subLine.slice(9, 10), 10); // betrouwbaarheid
    }
};
