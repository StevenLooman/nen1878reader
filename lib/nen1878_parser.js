...
var parser04 = {
    'I': function(subLine) {
        ...
        coordinate.functie = parseInt(subLine.slice(1, 2), 10); // functie van het coordinaatpunt: 1 = eerste punt van een object, 2 = rechtlijnige verbinding met het vorige punt, 4 = cirkelboogverbinding met het vorige punt
    },
    'X': function(subLine) {
        coordinate.x = parseInt(subLine.slice(1, 10), 10); // coordinaatgetal in millimeters
    },
    'Y': function(subLine) {
        coordinate.y = parseInt(subLine.slice(1, 10), 10); // coordinaatgetal in millimeters
