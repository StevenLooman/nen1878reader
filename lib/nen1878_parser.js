...
var parser04 = {
    ...
    'Q': function(subLine) {
        ...
        this.geometry.reliability = parseInt(subLine.slice(9, 10));A // betrouwbaarheid
    }
}

var parser05 = {
    'F': function(subLine) {
        this.pointOfText = parseInt(subLine.slice(1, 2)); // vast punt van tekst: 0 = plaats onbekend, 1 = linksonder, zie toelichting
...
var parser07 = {
    'N': function(line) {
        this.name = line.slice(03, 38); // naam beheerder
        this.id = line.slice(53, 61); // identificatie van beheerder
    },
    'A': function(line) {
        this.street = line.slice(03, 27), // straatnaam
    ...
    'W': function(line) {
        this.city = line.slice(03, 27); // vestigingslaats van beheerder
    }
}
