...
var parser04 = {
    'I': function(subLine) {
        record04.function = parseInt(subLine.slice(1, 2));
    },
    'X': function(subLine) {
        var x = parseInt(subLine.slice(1, 10));
        record04.x = x;
    },
    'Y': function(subLine) {
        var y = parseInt(subLine.slice(1, 10));
        record04.y = y;

        // save coordinate
        record.geometry.coordinates.push(record04);

        // create new record04 and copy function from last record04
        // if function is newly specified, the old value will be overwritten
        record04 = {
            function: record04.function
        };
    },
    'Q': function(subLine) {
...
var parser05 = {
    'F': function(subLine) {
        ...
        this.textOrSybmol = parseInt(subLine.slice(3, 4));
